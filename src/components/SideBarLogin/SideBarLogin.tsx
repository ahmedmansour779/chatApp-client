...
export default function SideBarLogin() {
  ...
  return (
    <div className={`tablet:absolute top-4 ${lang == "en" ? "left-4" : "right-4"} text-white tablet:w-2/4 w-full tablet:min-h-[95vh] h-[97%] flex tablet:items-end items-center flex-col justify-between z-10`}>
